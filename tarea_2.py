...
for nombre in lista_nombres_2:
    if lista_nombres_2.count(nombre) > 1:
        print(
            "El nombre: ", nombre, "se repite", lista_nombres_2.count(nombre), "veces"
        )
...
caracter = input("Introduce un caracter para saber si es vocal o no: ").lower()
...
min_number = int(input("Ingresa el numero minimo: "))
max_number = int(input("Ingresa el numero máximo: "))
...
if segundos < 60:
    ...
    print(
        "Los segundos que ingresaste equivalen a :",
        minutos,
        "minutos y",
        segundos_sobrantes,
        "segundos",
    ...
    print(
        "El tiempo que ingresaste equivale a:",
        hora,
        "hora(s)",
        minutos_sobrantes,
        "minutos y ",
